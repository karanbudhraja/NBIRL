...
function [best_output,total_time_taken] = npbfirlneat(algorithm_params, alg_params, nsamples, Eo)
...
[population, best_fitness, best_output]=npbfirlexperiment(population, number_input_nodes, algorithm_params.neat_input, algorithm_params.mdp_data, alg_params, nsamples, Eo);
...
%   if maximale_fitness>15.6025
   ...
   if maximale_fitness == size(algorithm_params.neat_input,1)
      flag_solution=1;
   end
...
%
% karan: now we need to return the best output
%
